...
public class EntertaimentPage extends AppCompatActivity {
    ...
    private void addControls() {
        ...
        String link = Configuration.RSS_LINK + Configuration.ENTERTAIMENT_LINK;
    ...
    public class GetRssFile extends AsyncTask<String, Void, ArrayList<NewsElements>> {
        ...
        protected void onPostExecute(ArrayList<NewsElements> newsElementses) {
            ...
            elementsAdapter = new ElementsAdapter(EntertaimentPage.this, R.layout.item_news, newsElementsArrayList);
