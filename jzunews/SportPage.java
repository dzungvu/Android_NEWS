...
public class SportPage extends AppCompatActivity {
    ...
    private void addControls() {
        ...
        String link = Configuration.RSS_LINK + Configuration.SPORT_LINK;
        ...
        lvNews.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(SportPage.this, WebViewContent.class);
    ...
    public class GetRssFile extends AsyncTask<String, Void, ArrayList<NewsElements>> {
        ...
        protected void onPostExecute(ArrayList<NewsElements> newsElementses) {
            ...
            elementsAdapter = new ElementsAdapter(SportPage.this, R.layout.item_news, newsElementsArrayList);
